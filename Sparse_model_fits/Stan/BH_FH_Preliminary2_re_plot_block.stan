...
data{
  ...
  int<lower = 0> K_block;          // Number of blocks
  ...
  // These variables index the effects for the plot and block
...
parameters{
  ...
  vector[K_plot] u_plot_std;                       // unscaled effects for the plot
  vector[K_block] u_block_std;                     // unscaled effects for the block
